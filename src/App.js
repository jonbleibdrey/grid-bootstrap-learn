      ...
      <Container style={{ padding: "20px", border: "5px solid red" }} fluid>
        <Row className="justify-content-md-center">
          <Col xs={12} lg={4} style={{ border: "5px solid red" }}>
            ...
            sunt iste accusantium ex maiores error numquam. <Liker />
            <DataComp
              name={data.name}
              last={data.lastName}
              hobbie={data.hobbie}
          ...
          <Col xs={12} lg={"auto"} style={{ border: "5px solid blue" }}>
            ...
            Quaerat vero quas iure cupiditate. <Liker />
            <DataComp
              name={data.name}
              last={data.lastName}
              hobbie={data.hobbie}
        ...
        <Row>
          ...
          >
            ...
            Eaque, aliquid magni voluptas esse itaque modi? <Liker />
            <DataComp
              name={data.name}
              last={data.lastName}
              hobbie={data.hobbie}
          ...
          <Col xs={12} lg={"auto"} style={{ border: "5px solid yellow" }}>
            ...
            eligendi quod tempore animi neque. Tempore, voluptatibus? <Liker />
            <DataComp
              name={data.name}
              last={data.lastName}
              hobbie={data.hobbie}
